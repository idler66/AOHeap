...
与Ω(logN)而言，这是非常大的性能提升。取L=128，N=2^32，T=2^m,有m + 7*2^m = 32, m < 3, 树的平均高度 T < 8。

理论和测试表明，临序堆优于fibonacci堆、pairing堆、dary堆、binomial堆和skew堆，键值变更次数越多、元素负载数据量愈大、元素入堆和出堆顺序越一致，其性能优势愈大。
